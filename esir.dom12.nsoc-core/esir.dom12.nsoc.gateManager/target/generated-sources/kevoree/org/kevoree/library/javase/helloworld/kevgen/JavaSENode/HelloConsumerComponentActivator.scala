...
class HelloConsumerComponentActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { HelloConsumerComponentFactory.createComponentActor() } }
