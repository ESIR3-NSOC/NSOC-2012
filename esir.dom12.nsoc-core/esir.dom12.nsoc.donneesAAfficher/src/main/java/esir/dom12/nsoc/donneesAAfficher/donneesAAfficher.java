...
@Provides({
        ...
        @ProvidedPort(name = "entreeADEPlusUn", type = PortType.MESSAGE),
...
class donneesAAfficher extends AbstractComponentType{
   ...
   @Port(name = "entreeADE")
    ...
    public String[] emploiDuTemps() throws IOException{
    	int [] date = date();
    	String [] emploiDuTemps=getPortByName("comAde",Ade.class).planningSalleParDate(date[2], date[1], date[0], "41", "3");
    	return emploiDuTemps;
    }
   @Port(name = "entreeADEPlusUn")
   // renvoie l'emploi du temps du jour même et du jour suivant
   public String[] emploiDuTempsPlusUn() throws IOException{
   	int [] date = date();
