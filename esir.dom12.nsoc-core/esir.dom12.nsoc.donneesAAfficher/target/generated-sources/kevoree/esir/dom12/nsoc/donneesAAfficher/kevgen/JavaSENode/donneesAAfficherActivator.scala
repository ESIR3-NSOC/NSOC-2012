...
class donneesAAfficherActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { donneesAAfficherFactory.createComponentActor() } }
