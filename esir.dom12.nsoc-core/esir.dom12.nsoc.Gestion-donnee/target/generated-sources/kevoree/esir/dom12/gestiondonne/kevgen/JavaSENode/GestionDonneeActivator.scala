...
class GestionDonneeActivator extends org.kevoree.framework.osgi.KevoreeComponentActivator {
def callFactory() : KevoreeComponent = { GestionDonneeFactory.createComponentActor() } }
